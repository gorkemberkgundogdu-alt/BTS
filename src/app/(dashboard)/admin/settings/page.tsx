...
import { Settings2, User, Lock, Bell, CheckCircle2, AlertCircle } from 'lucide-react'
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4 border-t border-slate-800">
              ...
              <div className="space-y-2 text-xs text-slate-400">
                <p>Rol: <span className="text-white">{profile?.role}</span></p>
                <p>Durum: <span className="text-green-500">Aktif</span></p>
                <p>Kayıt: <span className="text-white">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-300">E-posta Bildirimleri</p>
                <p className="text-xs text-slate-400">Önemli güncellemeler için e-posta al</p>
              </div>
              <div className="w-12 h-6 bg-blue-500 rounded-full flex items-center px-1 cursor-pointer">
                <div className="w-4 h-4 bg-white rounded-full ml-auto" />
              </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-slate-400">Ortam</span>
